...
public class IMMAManikinFromErgoExport : ManikinBase{
	...
	FrameInterpolator frameInterPolationInfo = new FrameInterpolator();
  ...
  //  jointRightSC.SetParent(jointT1T2);
    ...
    public IMMAManikinFromErgoExport(string modelInfoFilename, string ctrlPointsFilename)
    {
	...
	public static IMMAManikinFromErgoExport TryParse(string json)
	{
		try
		{
			...
			if (msg.parser == "IMMAManikin")
			{
				...
				return new IMMAManikinFromErgoExport(modelInfoFilename, ctrlPointsFilename);
			}
		}
