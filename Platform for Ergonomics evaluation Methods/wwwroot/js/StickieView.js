...
function StickieView(container, settings){
    ...
    var testMarker = new THREE.Mesh(new THREE.SphereGeometry(.1, 16, 16), new THREE.MeshBasicMaterial({ color: "red" }));
...
//                console.log("bend",spineRot.y);
                ...
                var rot = stickie.quaternion.clone();
                ...
                //testMarker.position.copy(scene.worldToLocal(stickie.limbs[4].bones[0].p1));
                //stickie.data.frames[stickie.frameIdx].limbJointPositions.forEach(limb => {
                //    limb.forEach(p => {
                //        var m = new THREE.Mesh(new THREE.SphereGeometry(.02, 16, 16), new THREE.MeshBasicMaterial({ color: "green" }));
                //        scene.add(m);
                //        m.position.copy(parseVec3(p));
                //        console.log(p);
                //    });
                //});
