...
//using UnityEngine;
//public class ManikinTimelineData {
...
//	public ManikinTimelineData(ModelInfo modelInfo) {
...
//		time = Mathf.Min(getFinalTime(), Mathf.Max(0, time));
...
//		jointL5S1.parentJoint = null;
//		jointL3L4.parentJoint = jointL5S1;
//		jointT12L1.parentJoint = jointL3L4;
//		jointT6T7.parentJoint = jointT12L1;
//		jointT1T2.parentJoint = jointT6T7;
//		jointC6C7.parentJoint = jointT1T2;
//		jointC4C5.parentJoint = jointC6C7;
//		jointAtlantoAxial.parentJoint = jointC4C5;
//		jointEyeside.parentJoint = jointAtlantoAxial;
//		jointLeftHip.parentJoint = jointL5S1;
//		jointLeftKnee.parentJoint = jointLeftHip;
//		jointLeftAnkleRot.parentJoint = jointLeftKnee;
//		jointLeftAnkle.parentJoint = jointLeftAnkleRot;
//		jointLeftToes.parentJoint = jointLeftAnkle;
//		jointRightHip.parentJoint = jointL5S1;
//		jointRightKnee.parentJoint = jointRightHip;
//		jointRightAnkleRot.parentJoint = jointRightKnee;
//		jointRightAnkle.parentJoint = jointRightAnkleRot;
//		jointRightToes.parentJoint = jointRightAnkle;
//		jointRightSC.parentJoint = jointT1T2;
//		jointRightAC.parentJoint = jointRightSC;
//		jointRightGH.parentJoint = jointRightAC;
//		jointRightShoulderRotation.parentJoint = jointRightGH;
//		jointRightElbow.parentJoint = jointRightShoulderRotation;
//		jointRightWristRotation.parentJoint = jointRightElbow;
//		jointLeftSC.parentJoint = jointT1T2;
//		jointLeftAC.parentJoint = jointLeftSC;
//		jointLeftGH.parentJoint = jointLeftAC;
//		jointLeftShoulderRotation.parentJoint = jointLeftGH;
//		jointLeftElbow.parentJoint = jointLeftShoulderRotation;
//		jointLeftWristRotation.parentJoint = jointLeftElbow;
//		jointLeftWrist.parentJoint = jointLeftWristRotation;
//		jointLeft_IndexCarpal.parentJoint = jointLeftWrist;
//		jointLeft_IndexProximal.parentJoint = jointLeft_IndexCarpal;
//		jointLeft_IndexIntermediate.parentJoint = jointLeft_IndexProximal;
//		jointLeft_IndexDistal.parentJoint = jointLeft_IndexIntermediate;
//		jointLeft_MiddleCarpal.parentJoint = jointLeftWrist;
//		jointLeft_MiddleProximal.parentJoint = jointLeft_MiddleCarpal;
//		jointLeft_MiddleIntermediate.parentJoint = jointLeft_MiddleProximal;
//		jointLeft_MiddleDistal.parentJoint = jointLeft_MiddleIntermediate;
//		jointLeft_RingCarpal.parentJoint = jointLeftWrist;
//		jointLeft_RingProximal.parentJoint = jointLeft_RingCarpal;
//		jointLeft_RingIntermediate.parentJoint = jointLeft_RingProximal;
//		jointLeft_RingDistal.parentJoint = jointLeft_RingIntermediate;
//		jointLeft_PinkyCarpal.parentJoint = jointLeftWrist;
//		jointLeft_PinkyProximal.parentJoint = jointLeft_PinkyCarpal;
//		jointLeft_PinkyIntermediate.parentJoint = jointLeft_PinkyProximal;
//		jointLeft_PinkyDistal.parentJoint = jointLeft_PinkyIntermediate;
//		jointLeft_ThumbProximal.parentJoint = jointLeftWrist;
//		jointLeft_ThumbIntermediate.parentJoint = jointLeft_ThumbProximal;
//		jointLeft_ThumbDistal.parentJoint = jointLeft_ThumbIntermediate;
//		jointRightWrist.parentJoint = jointRightWristRotation;
//		jointRight_IndexCarpal.parentJoint = jointRightWrist;
//		jointRight_IndexProximal.parentJoint = jointRight_IndexCarpal;
//		jointRight_IndexIntermediate.parentJoint = jointRight_IndexProximal;
//		jointRight_IndexDistal.parentJoint = jointRight_IndexIntermediate;
//		jointRight_MiddleCarpal.parentJoint = jointRightWrist;
//		jointRight_MiddleProximal.parentJoint = jointRight_MiddleCarpal;
//		jointRight_MiddleIntermediate.parentJoint = jointRight_MiddleProximal;
//		jointRight_MiddleDistal.parentJoint = jointRight_MiddleIntermediate;
//		jointRight_RingCarpal.parentJoint = jointRightWrist;
//		jointRight_RingProximal.parentJoint = jointRight_RingCarpal;
//		jointRight_RingIntermediate.parentJoint = jointRight_RingProximal;
//		jointRight_RingDistal.parentJoint = jointRight_RingIntermediate;
//		jointRight_PinkyCarpal.parentJoint = jointRightWrist;
//		jointRight_PinkyProximal.parentJoint = jointRight_PinkyCarpal;
//		jointRight_PinkyIntermediate.parentJoint = jointRight_PinkyProximal;
//		jointRight_PinkyDistal.parentJoint = jointRight_PinkyIntermediate;
//		jointRight_ThumbProximal.parentJoint = jointRightWrist;
//		jointRight_ThumbIntermediate.parentJoint = jointRight_ThumbProximal;
//		jointRight_ThumbDistal.parentJoint = jointRight_ThumbIntermediate;
//	}
